...
import shortestdistance.mapaccess.*;
import shortestdistance.util.CompactLongMap;
import shortestdistance.util.SortedHeap;
import shortestdistance.util.StackSampler;
...
public class RoutingEngine extends Thread {
  ...
  private final int alternativeIndex = 0;
