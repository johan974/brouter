...
public class JohanRoutingEngineTest {
  ...
  public JohanRoutingEngineTest() throws IOException {
    workingDir = Files.createTempDirectory("brouter").toFile().getAbsolutePath();
  }

  public static void main(String[] args) throws IOException {
    JohanRoutingEngineTest test = new JohanRoutingEngineTest();
    System.out.println( "Shortest distance: " + test.johanPointOnly());
  }
